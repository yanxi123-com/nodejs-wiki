...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  oauth2.getProtectedResource(this._profileURL, accessToken, function (err, result, res) {
    ...
    var openid = (function() {
      var match = result.match(/"openid":"(\w+)"/);
      return match && match[1];
    }());

    var userInfoUrl = "https://graph.qq.com/user/get_user_info?access_token=" + accessToken
      + "&oauth_consumer_key=" + oauth2._clientId + "&openid=" + openid;
